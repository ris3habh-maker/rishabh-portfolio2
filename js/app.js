    ...
    filtered.forEach((p, i) => {
      ...
      el.innerHTML = `
        ...
        <div class="wi-info">
          ...
          ${p.liveUrl ? `<a href="${p.liveUrl}" target="_blank" rel="noopener" class="wi-live" data-stop-propagation="true">View live site â†—</a>` : ''}
        </div>
  ...
  if (testiGrid) {
    testiGrid.innerHTML = testimonialsData.map(t => `
      <div class="testi-card">
        <div class="testi-stars">${'â˜…'.repeat(t.rating)}</div>
